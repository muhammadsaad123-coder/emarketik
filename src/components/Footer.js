    ...
    <footer className="footer2">
      <div className="footer2-content">
        ...
        <div className="footer2-columns-container">
          <div className="footer2-column">
            ...
            <ul>
              ...
              <li>
                <a href="/contact">Ecommerce</a>
              </li>
              <li>
                <a href="/contact">Payments</a>
              </li>
              <li>
                <a href="/contact">Point of Sale</a>
              </li>
              <li>
          ...
          <div className="footer2-column">
            <h3>&nbsp;</h3>{" "}
            {/* This empty header is to keep alignment consistent */}
            <ul>
              <li>
                <a href="/email-marketing">Email Marketing</a>
              </li>
              <li>
                <a href="/contact">Listings</a>
              </li>
              <li>
                <a href="/contact">Reputation</a>
              </li>
              <li>
                <a href="/smm">Social</a>
              </li>
        ...
        <div className="footer2-column">
          ...
          <ul>
            ...
            <li>
              <a href="/contact">Real Estate</a>
            </li>
            <li>
              <a href="/contact">Attorney</a>
            </li>
            <li>
              <a href="/contact">More Industries...</a>
            </li>
          </ul>
        </div>
        <div className="footer2-column">
        ...
        <div className="footer2-column">
          ...
          <ul>
            <li>
              <a href="/contact">Online Help Center</a>
            </li>
            <li>
      ...
      <div className="footer2-bottom">
        <div className="footer2-bottom-left">
          ...
          <p>
            emarketick Limited is a Registered Organization Of United Kingdom
          </p>
        </div>
        <div className="footer2-bottom-right">
          <p>
            Create a emarketick© account and download our{" "}
        ...
        <div className="footer2-watermark">
          <p>
            This website was created by Muhammad Saad, a student of COMSATS
            Attock, using React for a dynamic and responsive experience. If you
            would like a similar website built with modern technologies, feel
            free to contact me at <a href="tel:03225425081">0322-5425081</a>.
          </p>
        </div>
      </div>
    </footer>
