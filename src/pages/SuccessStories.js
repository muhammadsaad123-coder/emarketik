...
import img4 from "../assets/images/success_img/4.webp";
import img5 from "../assets/images/success_img/5.webp";
import img6 from "../assets/images/success_img/6.webp";
import img7 from "../assets/images/success_img/7.webp";
import img8 from "../assets/images/success_img/8.webp";
...
const SuccessStories = () => {
  return (
    <div className="success-stories-container">
      ...
      <div className="story-card">
        <img src={img7} alt="ICMS Education System" />
        <h3>NTS Marketing | CEO Saeed Ahmed</h3>
        <p>
          “Saeed Ahmed, CEO of NTS Marketing, recognized the need to elevate
          their brand visibility and drive customer engagement. By collaborating
          with eMarketick Digital Marketing Agency, NTS Marketing witnessed a
          remarkable transformation in their online presence. Through innovative
          marketing strategies and targeted campaigns, NTS Marketing experienced
          increased brand recognition and customer loyalty. Saeed’s proactive
          approach, combined with eMarketick’s expertise, led to significant
          business growth and success.”
        </p>
      </div>

      <div className="story-card">
        <img src={img8} alt="ICMS Education System" />
        <h3>Skylite Builders Pvt Limited | CEO Adil Shafique</h3>
        <p>
          “Adil Shafique, CEO of Skylite Builders Pvt Limited, partnered with
          eMarketick Digital Marketing Agency to enhance their brand presence
          and streamline their marketing efforts. With a focus on digital
          branding and lead generation, Skylite Builders experienced a surge in
          inquiries and property sales. Adil’s visionary leadership, coupled
          with eMarketick’s strategic guidance, propelled Skylite Builders to
          new heights of success in the real estate industry.”
        </p>
      </div>

      <div className="story-card">
        <img src={img9} alt="ICMS Education System" />
        <h3>Etimaad International Pvt Limited | Director Fazal</h3>
        <p>
          “Director Fazal, representing Etimaad International Pvt Limited,
          embarked on a digital transformation journey with eMarketick Digital
          Marketing Agency. By leveraging innovative marketing strategies and
          targeted campaigns, Etimaad International witnessed a significant
          increase in brand visibility and customer engagement. Fazal’s
          commitment to excellence, combined with eMarketick’s expertise, drove
          measurable results and business growth for Etimaad International.”
        </p>
      </div>

      <div className="story-card">
        <img src={img10} alt="ICMS Education System" />
        <h3>AMSVPS Servers</h3>
        <p>
          “AMSVPS Servers, a leading provider of virtual private servers,
          partnered with eMarketick Digital Marketing Agency to enhance their
          online visibility and attract new customers. Through strategic digital
          marketing initiatives and targeted advertising, AMSVPS Servers
          experienced a surge in website traffic and customer acquisition. With
          a focus on customer satisfaction and business growth, AMSVPS Servers
          solidified its position as a trusted provider in the hosting
          industry.”
        </p>
      </div>
